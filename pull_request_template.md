<!--
  Thank you for contributing to the neuroimaging awesome list! 

  Please confirm your suggestion meets the criteria below.
  Change '[ ]' to '[x]' to endorse the top level bullets below
-->
...
- [ ] has demonstrated resource/code ownership. <br> Note: Pull requests authored by the same sole-proprietor of the linked resource/tool invite scrutiny. <br> A non-exclusive list of potential evidence for responsive authorship include:
  ...
  - [ ] **or** has resolved issues/bugs from unaffiliated reporters
- [ ] non-free (not [gratis][gratis], as-in-beer) are prefixed with '💲' (like flywheel and qmenta entries)


[gratis]: https://en.wikipedia.org/wiki/Free_software#Definition_and_the_four_essential_freedoms_of_free_software
